myMedBookController.controller('mymedtagController', function ($scope, $http, $stateParams, $cookies, $rootScope, OAuth, $q, $timeout, $mdDialog) {
    $scope.products = [];
    $('.mobile_MMB').show()
    $('.mobile_CDV').hide()
    ...
    $scope.init = function () {
        ...
        $(".mmb_mymedtag").addClass('mmb_selected');
